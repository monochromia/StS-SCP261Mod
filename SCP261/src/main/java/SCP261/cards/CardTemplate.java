...
public class CardTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = SCP261Mod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    ...
    public static final CardColor COLOR = CardColor.COLORLESS; //.Enums.COLOR_GRAY;
