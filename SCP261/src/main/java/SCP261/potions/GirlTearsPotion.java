...
public class GirlTearsPotion extends AbstractPotion {

    public static final String POTION_ID = SCP261Mod.makeID("GirlTearsPotion");
    ...
    @Override
    public AbstractPotion makeCopy() { return new GirlTearsPotion();    }
